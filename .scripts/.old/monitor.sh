...
case $action in
    "Lx")
        echo "-> Lx"
        xrandr --output $left --mode $leftres --pos $xleftpos --auto
    ...
    "xR")
        echo "-> xR"
        xrandr --output $right --mode $rightres --pos $xleftpos --auto
    ...
    "LR")
        echo "-> LR"
        xrandr --output $left --mode $leftres --pos $xleftpos --auto
        xrandr --output $right --mode $rightres --pos $xrightpos --auto
